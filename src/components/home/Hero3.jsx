...
export default function Hero3() {
  return (
    <div className="flex pt-[62px] pr-[37px] pb-[63px] pl-9 flex-col items-start gap-2.5 bg-[radial-gradient(50%50%at50%50%,#0B0F1722.93%)] min-w-screen min-h-screen overflow-hidden relative">
      
      <div className="shrink-0 w-[1367px] h-[899px] relative">
        <img
          src={elephantbg}
          className="rounded-[30px] w-[1367px] h-[899px] absolute left-0 top-0 max-w-none"
      ...
      <div className="absolute left-20 top-[343px] rounded-[25px] border-[1.5px] border-[rgba(255,255,255,0.25)] bg-[rgba(15,23,42,0.50)] shadow-[08px24px0rgba(0,0,0,0.25)] w-[370px] h-[85px]"></div>
      ...
      <div className="absolute left-[450px] top-[428px] w-[25px] h-[25px]"></div>

      <div className="absolute left-[475px] top-[453px] w-3.5 h-3.5"></div>
      ...
      <div className="absolute right-[627px] bottom-[135px] w-[180px] h-[29px] relative">
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_51_127"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_51_127"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div className="absolute left-[1330px] top-[488px] w-12 h-12 relative">
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-px absolute left-[29px] top-6"
        >
          <g filter="url(#filter0_d_51_152)">
            <path
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="BackgroundImageFix"
                result="effect1_dropShadow_51_152"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_51_152"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div className="absolute left-14 top-[488px] w-12 h-12 relative">
        <div className="rounded-[48px] bg-[#10B981] shadow-[04px16px0rgba(16,185,129,0.20)] w-12 h-12 absolute left-0 top-0"></div>
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-px absolute left-[17px] top-6"
        >
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="BackgroundImageFix"
                result="effect1_dropShadow_51_130"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_51_130"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <p className="absolute left-[104px] top-[360px] text-[#FFF] font-inter text-[19px] w-80 h-[52px] text-center">
