...
export default function Hero2() {
  return (
    <div className="flex pt-[68px] pr-[37px] pb-[68px] pl-9 flex-col items-start gap-2.5 bg-[radial-gradient(50%50%at50%50%,#0B0F1722.93%)] min-w-screen min-h-screen overflow-hidden relative">
      <div className="shrink-0 w-[1367px] h-[888px] relative">
        <img
          src={rhinobg}
          className="rounded-[30px] w-[1367px] h-[888px] absolute left-0 top-0 max-w-none"
      ...
      <div className="absolute right-[162px] top-[335px] w-[409px] h-[124px] relative">
        <div className="rounded-[25px] border-[1.5px] border-[rgba(255,255,255,0.25)] bg-[rgba(15,23,42,0.50)] shadow-[08px24px0rgba(0,0,0,0.25)] w-[370px] h-[85px] absolute left-0 top-0"></div>
        <div className="w-[25px] h-[25px] absolute -left-[370px] top-[85px]"></div>
        <div className="w-3.5 h-3.5 absolute -left-[395px] top-[110px]"></div>
      </div>
      ...
      <div className="absolute right-[603px] bottom-[138px] w-[210px] h-[62px] relative">
        <div className="rounded-[100px] border border-[#10B981] bg-[#10B981] shadow-[04px20px0rgba(16,185,129,0.20)] w-[210px] h-[62px] absolute left-0 top-0"></div>

        <p className="text-[#F8FAFC] font-inter text-2xl font-bold w-[161px] h-[29px] absolute left-[18px] top-4">
          LET’S BEGIN
        </p>
        ...
        <svg
          ...
          className="w-6 absolute left-[174px] top-8"
        >
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_77_21"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_77_21"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div className="absolute left-[1330px] top-[488px] w-12 h-12 relative">
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="BackgroundImageFix"
                result="effect1_dropShadow_77_24"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_77_24"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <div className="absolute left-[41px] top-[488px] w-12 h-12 relative">
        ...
        >
          <g filter="url(#filter0_d_77_27)">
            <path
              d="M7 16.728H9V12.728H7V14.728V16.728ZM4.58579 13.3138C3.80474 14.0949 3.80474 16.1421 4.58579 16.1421L17.3137 28.8702C18.0948 29.6512 19.3611 29.6512 20.1421 28.8702C20.9232 28.0891 20.9232 26.8228 20.1421 26.0417L8.82843 14.728L20.1421 3.41432C20.9232 2.63327 20.9232 1.36694 20.1421 0.585892C20.1421 -0.195157 18.0948 -0.195157 17.3137 0.585892L4.58579 13.3138ZM7 14.728V12.728H6V14.728V16.728Z"
              fill="#F8FAFC"
            />
          </g>
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="BackgroundImageFix"
                result="effect1_dropShadow_77_27"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_dropShadow_77_27"
                result="shape"
              />
            </filter>
          </defs>
      ...
      <p className="absolute right-[187px] top-[369px] text-[#FFF] font-inter text-[19px] w-80 h-[33px] text-center">
